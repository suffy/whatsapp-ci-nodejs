						...
						<div class="col-md-8">
							...
							<form action="<?= base_url('welcome/send'); ?>" method="post">
								<div class="form-group first">
									<label for="username">no hp tujuan</label>
									<input type="text" class="form-control" id="username" name='tujuan'>

								</div>
								<div class="form-group last mb-4">
									<label for="password">pesan</label>
									<input type="text" class="form-control" id="password" name='message'>
